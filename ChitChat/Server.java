...
class Server extends JFrame implements ActionListener
{
    ...
    Server()
    {
        ...
        (browse   = new JButton("Browse")).setForeground(new java.awt.Color(25,22,69));
        (start    = new JButton("Send File")).setForeground(new java.awt.Color(25,22,69));
		browse = new JButton("Browse");
		//browse.setBackground(new Color(25,22,69));
		//browse.setForeground(new Color(229,229,229));
        ...
        (nameLabel  = new JLabel("File Name")).setForeground(new Color(25,22,69));
        (sizeLabel  = new JLabel("File Size")).setForeground(new Color(25,22,69));
        (typeLabel  = new JLabel("File Type")).setForeground(new Color(25,22,69));
        (title      = new JLabel("  Smart File Transfer (Server)")).setForeground(new Color(229,229,229));
        (address    = new JLabel("Type this in client app : "+serverAddress+" ")).setForeground(new Color(25,22,69));
        (status     = new JLabel("Select File and Start Server")).setForeground(new Color(229,229,229));

        panel = new JPanel();
        panel.setBackground(new Color(0,204,204));
		setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("LAN chatting");
        ...
        setFont(new Font("Tahoma",Font.BOLD,20),nameLabel,sizeLabel,typeLabel);
        setFont(new Font("Times new roman",Font.PLAIN,14),nameField,sizeField,typeField);
        setFont(new Font("tahoma",Font.BOLD,20),address);
        setFont(new Font("Tahoma",Font.PLAIN,20),start,browse,status,title);
		browse.setBackground(new Color(25,22,69));
		start.setBackground(new Color(25,22,69));
        ...
        getRootPane().setBorder(BorderFactory.createLineBorder(new Color(225,225,225),5));
    ...
    private void startServer()
    {
		...
		String data,fileName =(nameField.getText().substring(nameField.getText().lastIndexOf("\\")));
